...
const WOO_ACCOUNT_SHEET_NAME = "Overview";
...
function processBatchCore_() {
  ...
  try {
    ...
    if (state.phase === 'FETCH_PRODUCTS') {
      executeFetchProductsPhase_(config, state, productMap, executionStart);
    }

    if (state.phase === 'FETCH_ORDERS' && !isTimeUp_(executionStart)) {
      executeFetchOrdersPhase_(config, state, productMap, executionStart);
    }

    if (state.phase === 'WRITE_DATA' && !isTimeUp_(executionStart)) {
      executeWriteDataPhase_(config, state, productMap, executionStart, ss);
...
// =========================================================================================
function executeFetchProductsPhase_(config, state, productMap, executionStart) {
...
// =========================================================================================
function executeFetchOrdersPhase_(config, state, productMap, executionStart) {
...
// =========================================================================================
function executeWriteDataPhase_(config, state, productMap, executionStart, ss) {
  const scriptProperties = PropertiesService.getScriptProperties();
